...
We are excited to announce that {{page.year | replace: "CGVC","CGVC "}} {{ info.homepage_announcement }} The [call for papers]({{page.year}}/cfp.html) and [additional information]({{page.year}}) are now available.
